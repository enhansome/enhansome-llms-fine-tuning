...
* [LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory) ⭐ 74,231 | 🐛 1,113 | 🌐 Python | 📅 2026-08-18: An easy-to-use LLM fine-tuning framework (LLaMA-2, BLOOM, Falcon, Baichuan, Qwen, ChatGLM3). (5532 stars)
* [LlamaIndex](https://github.com/run-llama/llama_index) ⭐ 51,745 | 🐛 641 | 🌐 Python | 📅 2026-08-19 🦙: A data framework for your LLM applications. (23010 stars)
...
* [Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,112 | 🐛 951 | 🌐 Python | 📅 2026-08-19: AI Observability & Evaluation - Evaluate, troubleshoot, and fine tune your LLM, CV, and NLP models in a notebook. (1596 stars)
...
* [xtuner](https://github.com/InternLM/xtuner) ⭐ 5,178 | 🐛 359 | 🌐 Python | 📅 2026-08-19: A toolkit for efficiently fine-tuning LLM (InternLM, Llama, Baichuan, QWen, ChatGLM2). (540 stars)
...
* [AutoTrain](https://github.com/huggingface/autotrain-advanced) ⭐ 4,607 | 🐛 6 | 🌐 Python | 📅 2026-07-21 - No code fine-tuning of LLMs and other machine learning tasks.
